...
CREATE TABLE `electricity_readings` (
  ...
  CONSTRAINT `electricity_readings_ibfk_1` FOREIGN KEY (`meter_id`) REFERENCES `meters` (`meter_id`)
...
LOCK TABLES `electricity_readings` WRITE;
/*!40000 ALTER TABLE `electricity_readings` DISABLE KEYS */;
/*!40000 ALTER TABLE `electricity_readings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-02-16 11:52:29
